    ...
    public static class PropertyMetadataExtensions
    {
            ...
            IEnumerable<PropertyValue> properties)
        {
            ...
            if (more.Any())
            {
                ...
                errors.Add(String.Format(Resources.Messages.UnrecognizedProperties, types));
            }
            ...
            if (less.Any())
            {
                ...
                errors.Add(String.Format(Resources.Messages.MissingRequiredProperties, types));
            }
        ...
        public static string Validate(this PropertyMetadata property, string value)
        {
            ...
            {
                return String.Format(Resources.Messages.IsRequired, property.Name);
            }
            else if (!String.IsNullOrWhiteSpace(value))
            {
                if (property.DataType == PropertyDataType.Boolean)
                {
                    ...
                    {
                        return String.Format(Resources.Messages.InvalidBoolean, property.Name);
                    }
                }
                ...
                if (property.DataType == PropertyDataType.Email)
                {
                    if (!value.Contains("@"))
                    {
                        return String.Format(Resources.Messages.InvalidEmail, property.Name);
                    }
                }
                ...
                if (property.DataType == PropertyDataType.Number)
                {
                    ...
                    {
                        return String.Format(Resources.Messages.InvalidNumber, property.Name);
                    }
                }
                ...
                if (property.DataType == PropertyDataType.Url)
                {
                    ...
                    {
                        return String.Format(Resources.Messages.InvalidUrl, property.Name);
                    }
                }
            }
